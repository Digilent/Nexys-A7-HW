...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "In order to respect the timing I have chosen 
to generate from MIG 600Mbps. ( 600/2 = 300MHz).
The ui_clk will be 75 Mhz ( 300/4 = 75 Mhz. 
Because we have a ratio of 4:1).
After analysing the values of the MIG MMCM for :
CLK_MUl, CLKIN_PERIOD and CLKOUT0_DIVIDE_F
I have found that the additional clock produces has an 
error factor of 0.9375. This means that in order to produce a
clock signal of 200MHz for my clk_ref_i, the MIG must 
generate a clock of 213.333MHz ( 200 / 0.9375 = 213.333).
Opening the IP" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set axis2fifo_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.AXIS_KEEP_WIDTH {1} \
   CONFIG.FIFO_DATA_WIDTH {16} \
 ] $axis2fifo_0

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_0 ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {46.870000000000005} \
   CONFIG.CLKOUT1_DRIVES {BUFG} \
   CONFIG.CLKOUT1_JITTER {195.461} \
   CONFIG.CLKOUT1_PHASE_ERROR {169.418} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {24.576} \
   CONFIG.CLKOUT2_DRIVES {BUFG} \
   CONFIG.CLKOUT2_JITTER {719.529} \
   CONFIG.CLKOUT2_PHASE_ERROR {785.127} \
   ...
   CONFIG.MMCM_CLKIN1_PERIOD {4.687} \
   ...
   CONFIG.PRIM_IN_FREQ {213.333334} \
  ...
  connect_bd_net -net Net1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins fifo2audpwm_0/clk] [get_bd_pins fifo_generator_0/rd_clk]
  connect_bd_net -net SYS_Rst_1 [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_mig_7series_0_81M/bus_struct_reset]
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins mig_7series_0/clk_ref_i] [get_bd_pins mig_7series_0/ui_addn_clk_0]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins GPIO_IN/s_axi_aclk] [get_bd_pins GPIO_OUT/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axis2fifo_0/clk] [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/sys_clock] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk] [get_bd_pins tone_generator_0/clk]
